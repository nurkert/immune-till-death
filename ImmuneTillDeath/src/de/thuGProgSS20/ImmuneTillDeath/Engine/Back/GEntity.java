...
public abstract class GEntity extends GObject implements GEventListener, Collidable {
	 ...
	 */
	public GEntity(GLocation location, double speed, double hitRadius, EntityType type) {
		super(location, GLayor.MAIN4, true, false);
